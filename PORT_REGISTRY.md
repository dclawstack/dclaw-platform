...
| **3067** | DClaw Agent frontend dev | Local dev | Shell | ✅ Assigned |
| **8155** | dclaw-risk backend | Local + K8s | Shell | ✅ Assigned |
| **3068** | DClaw Risk frontend dev | Local dev | Shell | ✅ Assigned |
