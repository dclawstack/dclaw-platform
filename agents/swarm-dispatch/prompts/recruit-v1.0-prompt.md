# DClaw Recruit v1.0 — Swarm Agent Prompt

> **Agent Role:** Product Architect + Full-Stack Engineer + Design Systems Specialist
> **Mission:** Take DClaw Recruit from scaffold (v0.1.0) to production-ready v1.0 by researching the market, designing future-proof AI-native features, and producing a complete build specification.
...
name: DClaw Recruit
category: Talent
tagline: Job posting and candidate ranking
current_version: 0.1.0
status: P4 Planned
repo: https://github.com/dclawstack/dclaw-recruit
docs: https://docs.dclawstack.io/apps/recruit
frontend_port: 3040
backend_port: 8040
db_name: dclaw_recruit
brand_color: #EC4899
icon: 🤝
```
...
Research the Talent category and identify the 5 most relevant competitors to DClaw Recruit. For each:
- Name + URL
...
| Feature | DClaw Recruit (v0.1) | Competitor A | Competitor B | Competitor C | Competitor D | Competitor E |
|---------|---------------------------|--------------|--------------|--------------|--------------|--------------|
| Feature 1 | ❌ | ✅ | ✅ | ❌ | ✅ | ✅ |
| Feature 2 | ... | ... | ... | ... | ... | ... |
...
### 1.4 Trends Analysis
Research 2026-2027 trends in the Talent category:
...
Features that are table stakes. Without these, DClaw Recruit is not viable.
...
Apply the **DKube Design System** to DClaw Recruit:
...
| Token | Value | Usage |
|-------|-------|-------|
| `--dk-purple` | #EC4899 | Primary actions, links |
| `--dk-purple-light` | #F38DBF | Hover states, accents |
| `--dk-purple-deep` | #D11572 | Pressed states |
| `--dk-purple-wash` | #F7F2F4 | Section backgrounds |
...
### 4.4 Dark Mode
DClaw Recruit supports both light and dark modes. Define the dark mode color mapping:
...
Structure:
```
# DClaw Recruit v1.0 Specification
