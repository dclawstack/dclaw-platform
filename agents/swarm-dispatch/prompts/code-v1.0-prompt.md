# DClaw Code v1.0 — Swarm Agent Prompt

> **Agent Role:** Product Architect + Full-Stack Engineer + Design Systems Specialist
> **Mission:** Take DClaw Code from scaffold (v0.1.0) to production-ready v1.0 by researching the market, designing future-proof AI-native features, and producing a complete build specification.
...
status: P2 Queued
repo: https://github.com/dclawstack/dclaw-code
docs: https://docs.dclawstack.io/apps/code
frontend_port: 3007
backend_port: 8007
db_name: dclaw_code
brand_color: #1F2937
...
Research the Development category and identify the 5 most relevant competitors to DClaw Code. For each:
- Name + URL
...
| Feature | DClaw Code (v0.1) | Competitor A | Competitor B | Competitor C | Competitor D | Competitor E |
|---------|---------------------------|--------------|--------------|--------------|--------------|--------------|
| Feature 1 | ❌ | ✅ | ✅ | ❌ | ✅ | ✅ |
| Feature 2 | ... | ... | ... | ... | ... | ... |
...
### 1.4 Trends Analysis
Research 2026-2027 trends in the Development category:
...
Features that are table stakes. Without these, DClaw Code is not viable.
...
Apply the **DKube Design System** to DClaw Code:
...
### 4.4 Dark Mode
DClaw Code supports both light and dark modes. Define the dark mode color mapping:
