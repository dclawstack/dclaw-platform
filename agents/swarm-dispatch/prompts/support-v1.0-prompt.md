# DClaw Support v1.0 — Swarm Agent Prompt

> **Agent Role:** Product Architect + Full-Stack Engineer + Design Systems Specialist
> **Mission:** Take DClaw Support from scaffold (v0.1.0) to production-ready v1.0 by researching the market, designing future-proof AI-native features, and producing a complete build specification.
...
name: DClaw Support
category: Support
tagline: Ticket resolution and knowledge base AI
current_version: 0.1.0
status: P4 Planned
repo: https://github.com/dclawstack/dclaw-support
docs: https://docs.dclawstack.io/apps/support
frontend_port: 3013
backend_port: 8013
db_name: dclaw_support
brand_color: #06B6D4
icon: 🎧
```
...
Research the Support category and identify the 5 most relevant competitors to DClaw Support. For each:
- Name + URL
...
| Feature | DClaw Support (v0.1) | Competitor A | Competitor B | Competitor C | Competitor D | Competitor E |
|---------|---------------------------|--------------|--------------|--------------|--------------|--------------|
| Feature 1 | ❌ | ✅ | ✅ | ❌ | ✅ | ✅ |
| Feature 2 | ... | ... | ... | ... | ... | ... |
...
### 1.4 Trends Analysis
Research 2026-2027 trends in the Support category:
...
Features that are table stakes. Without these, DClaw Support is not viable.
...
Apply the **DKube Design System** to DClaw Support:
...
| Token | Value | Usage |
|-------|-------|-------|
| `--dk-purple` | #06B6D4 | Primary actions, links |
| `--dk-purple-light` | #2DDBF9 | Hover states, accents |
| `--dk-purple-deep` | #037689 | Pressed states |
| `--dk-purple-wash` | #F1F6F7 | Section backgrounds |
...
### 4.4 Dark Mode
DClaw Support supports both light and dark modes. Define the dark mode color mapping:
...
Structure:
```
# DClaw Support v1.0 Specification
