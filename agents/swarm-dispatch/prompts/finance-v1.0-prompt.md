# DClaw Finance v1.0 — Swarm Agent Prompt

> **Agent Role:** Product Architect + Full-Stack Engineer + Design Systems Specialist
> **Mission:** Take DClaw Finance from scaffold (v0.1.0) to production-ready v1.0 by researching the market, designing future-proof AI-native features, and producing a complete build specification.
...
Research the Finance category and identify the 5 most relevant competitors to DClaw Finance. For each:
- Name + URL
...
| Feature | DClaw Finance (v0.1) | Competitor A | Competitor B | Competitor C | Competitor D | Competitor E |
|---------|---------------------------|--------------|--------------|--------------|--------------|--------------|
| Feature 1 | ❌ | ✅ | ✅ | ❌ | ✅ | ✅ |
| Feature 2 | ... | ... | ... | ... | ... | ... |
...
### 1.4 Trends Analysis
Research 2026-2027 trends in the Finance category:
...
Features that are table stakes. Without these, DClaw Finance is not viable.
...
Apply the **DKube Design System** to DClaw Finance:
...
### 4.4 Dark Mode
DClaw Finance supports both light and dark modes. Define the dark mode color mapping:
...
Structure:
```
# DClaw Finance v1.0 Specification
