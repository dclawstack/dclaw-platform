# DClaw Learn v1.0 — Swarm Agent Prompt

> **Agent Role:** Product Architect + Full-Stack Engineer + Design Systems Specialist
> **Mission:** Take DClaw Learn from scaffold (v0.1.0) to production-ready v1.0 by researching the market, designing future-proof AI-native features, and producing a complete build specification.
...
status: P2 Queued
repo: https://github.com/dclawstack/dclaw-learn
docs: https://docs.dclawstack.io/apps/learn
frontend_port: 3006
backend_port: 8006
db_name: dclaw_learn
brand_color: #6366F1
...
Research the Education category and identify the 5 most relevant competitors to DClaw Learn. For each:
- Name + URL
...
| Feature | DClaw Learn (v0.1) | Competitor A | Competitor B | Competitor C | Competitor D | Competitor E |
|---------|---------------------------|--------------|--------------|--------------|--------------|--------------|
| Feature 1 | ❌ | ✅ | ✅ | ❌ | ✅ | ✅ |
| Feature 2 | ... | ... | ... | ... | ... | ... |
...
### 1.4 Trends Analysis
Research 2026-2027 trends in the Education category:
...
Features that are table stakes. Without these, DClaw Learn is not viable.
...
Apply the **DKube Design System** to DClaw Learn:
...
### 4.4 Dark Mode
DClaw Learn supports both light and dark modes. Define the dark mode color mapping:
...
Structure:
```
# DClaw Learn v1.0 Specification
