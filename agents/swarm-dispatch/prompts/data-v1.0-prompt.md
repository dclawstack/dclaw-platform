# DClaw Data v1.0 — Swarm Agent Prompt

> **Agent Role:** Product Architect + Full-Stack Engineer + Design Systems Specialist
> **Mission:** Take DClaw Data from scaffold (v0.1.0) to production-ready v1.0 by researching the market, designing future-proof AI-native features, and producing a complete build specification.
...
status: P4 Planned
repo: https://github.com/dclawstack/dclaw-data
...
Research the Analytics category and identify the 5 most relevant competitors to DClaw Data. For each:
- Name + URL
...
| Feature | DClaw Data (v0.1) | Competitor A | Competitor B | Competitor C | Competitor D | Competitor E |
|---------|---------------------------|--------------|--------------|--------------|--------------|--------------|
| Feature 1 | ❌ | ✅ | ✅ | ❌ | ✅ | ✅ |
| Feature 2 | ... | ... | ... | ... | ... | ... |
...
### 1.4 Trends Analysis
Research 2026-2027 trends in the Analytics category:
...
Features that are table stakes. Without these, DClaw Data is not viable.
...
Apply the **DKube Design System** to DClaw Data:
...
| Token | Value | Usage |
|-------|-------|-------|
| `--dk-purple` | #14B8A6 | Primary actions, links |
| `--dk-purple-light` | #30E8D4 | Hover states, accents |
| `--dk-purple-deep` | #0C7267 | Pressed states |
| `--dk-purple-wash` | #F2F7F6 | Section backgrounds |
...
### 4.4 Dark Mode
DClaw Data supports both light and dark modes. Define the dark mode color mapping:
