# DClaw Train v1.0 — Swarm Agent Prompt

> **Agent Role:** Product Architect + Full-Stack Engineer + Design Systems Specialist
> **Mission:** Take DClaw Train from scaffold (v0.1.0) to production-ready v1.0 by researching the market, designing future-proof AI-native features, and producing a complete build specification.
...
name: DClaw Train
category: L&D
tagline: Employee training and certification tracking
current_version: 0.1.0
status: P4 Planned
repo: https://github.com/dclawstack/dclaw-train
docs: https://docs.dclawstack.io/apps/train
frontend_port: 3039
backend_port: 8039
db_name: dclaw_train
brand_color: #D946EF
...
Research the L&D category and identify the 5 most relevant competitors to DClaw Train. For each:
- Name + URL
...
| Feature | DClaw Train (v0.1) | Competitor A | Competitor B | Competitor C | Competitor D | Competitor E |
|---------|---------------------------|--------------|--------------|--------------|--------------|--------------|
| Feature 1 | ❌ | ✅ | ✅ | ❌ | ✅ | ✅ |
| Feature 2 | ... | ... | ... | ... | ... | ... |
...
### 1.4 Trends Analysis
Research 2026-2027 trends in the L&D category:
...
Features that are table stakes. Without these, DClaw Train is not viable.
...
Apply the **DKube Design System** to DClaw Train:
...
| Token | Value | Usage |
|-------|-------|-------|
| `--dk-purple` | #D946EF | Primary actions, links |
| `--dk-purple-light` | #E78CF5 | Hover states, accents |
| `--dk-purple-deep` | #BC12D5 | Pressed states |
| `--dk-purple-wash` | #F6F2F7 | Section backgrounds |
...
### 4.4 Dark Mode
DClaw Train supports both light and dark modes. Define the dark mode color mapping:
...
Structure:
```
# DClaw Train v1.0 Specification
