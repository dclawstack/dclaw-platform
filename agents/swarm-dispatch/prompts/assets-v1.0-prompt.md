# DClaw Assets v1.0 — Swarm Agent Prompt

> **Agent Role:** Product Architect + Full-Stack Engineer + Design Systems Specialist
> **Mission:** Take DClaw Assets from scaffold (v0.1.0) to production-ready v1.0 by researching the market, designing future-proof AI-native features, and producing a complete build specification.
...
status: P4 Planned
repo: https://github.com/dclawstack/dclaw-assets
docs: https://docs.dclawstack.io/apps/assets
frontend_port: 3043
backend_port: 8043
db_name: dclaw_assets
brand_color: #64748B
icon: 🖥️
```
...
Research the IT category and identify the 5 most relevant competitors to DClaw Assets. For each:
- Name + URL
...
| Feature | DClaw Assets (v0.1) | Competitor A | Competitor B | Competitor C | Competitor D | Competitor E |
|---------|---------------------------|--------------|--------------|--------------|--------------|--------------|
| Feature 1 | ❌ | ✅ | ✅ | ❌ | ✅ | ✅ |
| Feature 2 | ... | ... | ... | ... | ... | ... |
...
Features that are table stakes. Without these, DClaw Assets is not viable.
...
Apply the **DKube Design System** to DClaw Assets:
...
### 4.4 Dark Mode
DClaw Assets supports both light and dark modes. Define the dark mode color mapping:
...
Structure:
```
# DClaw Assets v1.0 Specification
