# DClaw Slide v1.0 — Swarm Agent Prompt

> **Agent Role:** Product Architect + Full-Stack Engineer + Design Systems Specialist
> **Mission:** Take DClaw Slide from scaffold (v0.1.0) to production-ready v1.0 by researching the market, designing future-proof AI-native features, and producing a complete build specification.
...
status: P4 Planned
repo: https://github.com/dclawstack/dclaw-slide
docs: https://docs.dclawstack.io/apps/slide
frontend_port: 3021
backend_port: 8021
db_name: dclaw_slide
brand_color: #E11D48
...
Research the Presentations category and identify the 5 most relevant competitors to DClaw Slide. For each:
- Name + URL
...
| Feature | DClaw Slide (v0.1) | Competitor A | Competitor B | Competitor C | Competitor D | Competitor E |
|---------|---------------------------|--------------|--------------|--------------|--------------|--------------|
| Feature 1 | ❌ | ✅ | ✅ | ❌ | ✅ | ✅ |
| Feature 2 | ... | ... | ... | ... | ... | ... |
...
### 1.4 Trends Analysis
Research 2026-2027 trends in the Presentations category:
...
Features that are table stakes. Without these, DClaw Slide is not viable.
...
Apply the **DKube Design System** to DClaw Slide:
...
| Token | Value | Usage |
|-------|-------|-------|
| `--dk-purple` | #E11D48 | Primary actions, links |
| `--dk-purple-light` | #EA5F7E | Hover states, accents |
| `--dk-purple-deep` | #9D1432 | Pressed states |
| `--dk-purple-wash` | #F7F2F3 | Section backgrounds |
...
### 4.4 Dark Mode
DClaw Slide supports both light and dark modes. Define the dark mode color mapping:
...
Structure:
```
# DClaw Slide v1.0 Specification
