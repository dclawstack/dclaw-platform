# DClaw RAG v1.0 — Swarm Agent Prompt

> **Agent Role:** Product Architect + Full-Stack Engineer + Design Systems Specialist
> **Mission:** Take DClaw RAG from scaffold (v0.1.0) to production-ready v1.0 by researching the market, designing future-proof AI-native features, and producing a complete build specification.
...
status: P1 Queued
repo: https://github.com/dclawstack/dclaw-rag
docs: https://docs.dclawstack.io/apps/rag
frontend_port: 3004
backend_port: 8004
db_name: dclaw_rag
brand_color: #F59E0B
...
Research the Platform category and identify the 5 most relevant competitors to DClaw RAG. For each:
- Name + URL
...
| Feature | DClaw RAG (v0.1) | Competitor A | Competitor B | Competitor C | Competitor D | Competitor E |
|---------|---------------------------|--------------|--------------|--------------|--------------|--------------|
| Feature 1 | ❌ | ✅ | ✅ | ❌ | ✅ | ✅ |
| Feature 2 | ... | ... | ... | ... | ... | ... |
...
Features that are table stakes. Without these, DClaw RAG is not viable.
...
Apply the **DKube Design System** to DClaw RAG:
...
### 4.4 Dark Mode
DClaw RAG supports both light and dark modes. Define the dark mode color mapping:
