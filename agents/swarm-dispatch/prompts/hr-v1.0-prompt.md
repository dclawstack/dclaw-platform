# DClaw HR v1.0 — Swarm Agent Prompt

> **Agent Role:** Product Architect + Full-Stack Engineer + Design Systems Specialist
> **Mission:** Take DClaw HR from scaffold (v0.1.0) to production-ready v1.0 by researching the market, designing future-proof AI-native features, and producing a complete build specification.
...
name: DClaw HR
category: HR
tagline: Resume screening, interview prep, and onboarding
current_version: 0.1.0
status: P4 Planned
repo: https://github.com/dclawstack/dclaw-hr
...
Research the HR category and identify the 5 most relevant competitors to DClaw HR. For each:
- Name + URL
...
| Feature | DClaw HR (v0.1) | Competitor A | Competitor B | Competitor C | Competitor D | Competitor E |
|---------|---------------------------|--------------|--------------|--------------|--------------|--------------|
| Feature 1 | ❌ | ✅ | ✅ | ❌ | ✅ | ✅ |
| Feature 2 | ... | ... | ... | ... | ... | ... |
...
Features that are table stakes. Without these, DClaw HR is not viable.
...
Apply the **DKube Design System** to DClaw HR:
...
### 4.4 Dark Mode
DClaw HR supports both light and dark modes. Define the dark mode color mapping:
