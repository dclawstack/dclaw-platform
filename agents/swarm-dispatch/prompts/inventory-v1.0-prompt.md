# DClaw Inventory v1.0 — Swarm Agent Prompt

> **Agent Role:** Product Architect + Full-Stack Engineer + Design Systems Specialist
> **Mission:** Take DClaw Inventory from scaffold (v0.1.0) to production-ready v1.0 by researching the market, designing future-proof AI-native features, and producing a complete build specification.
...
status: P4 Planned
repo: https://github.com/dclawstack/dclaw-inventory
docs: https://docs.dclawstack.io/apps/inventory
frontend_port: 3045
backend_port: 8045
db_name: dclaw_inventory
brand_color: #F59E0B
icon: 📦
```
...
Research the Operations category and identify the 5 most relevant competitors to DClaw Inventory. For each:
- Name + URL
...
| Feature | DClaw Inventory (v0.1) | Competitor A | Competitor B | Competitor C | Competitor D | Competitor E |
|---------|---------------------------|--------------|--------------|--------------|--------------|--------------|
| Feature 1 | ❌ | ✅ | ✅ | ❌ | ✅ | ✅ |
| Feature 2 | ... | ... | ... | ... | ... | ... |
...
Features that are table stakes. Without these, DClaw Inventory is not viable.
...
Apply the **DKube Design System** to DClaw Inventory:
...
### 4.4 Dark Mode
DClaw Inventory supports both light and dark modes. Define the dark mode color mapping:
...
Structure:
```
# DClaw Inventory v1.0 Specification
