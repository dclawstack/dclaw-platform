# DClaw Migrate v1.0 — Swarm Agent Prompt

> **Agent Role:** Product Architect + Full-Stack Engineer + Design Systems Specialist
> **Mission:** Take DClaw Migrate from scaffold (v0.1.0) to production-ready v1.0 by researching the market, designing future-proof AI-native features, and producing a complete build specification.
...
status: P4 Planned
repo: https://github.com/dclawstack/dclaw-migrate
docs: https://docs.dclawstack.io/apps/migrate
frontend_port: 3033
backend_port: 8033
db_name: dclaw_migrate
brand_color: #64748B
icon: 🚚
```
...
Research the Infrastructure category and identify the 5 most relevant competitors to DClaw Migrate. For each:
- Name + URL
...
| Feature | DClaw Migrate (v0.1) | Competitor A | Competitor B | Competitor C | Competitor D | Competitor E |
|---------|---------------------------|--------------|--------------|--------------|--------------|--------------|
| Feature 1 | ❌ | ✅ | ✅ | ❌ | ✅ | ✅ |
| Feature 2 | ... | ... | ... | ... | ... | ... |
...
Features that are table stakes. Without these, DClaw Migrate is not viable.
...
Apply the **DKube Design System** to DClaw Migrate:
...
| Token | Value | Usage |
|-------|-------|-------|
| `--dk-purple` | #64748B | Primary actions, links |
| `--dk-purple-light` | #8D9AAD | Hover states, accents |
| `--dk-purple-deep` | #434E5E | Pressed states |
...
### 4.4 Dark Mode
DClaw Migrate supports both light and dark modes. Define the dark mode color mapping:
...
Structure:
```
# DClaw Migrate v1.0 Specification
