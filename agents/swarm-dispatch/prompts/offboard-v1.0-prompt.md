# DClaw Offboard v1.0 — Swarm Agent Prompt

> **Agent Role:** Product Architect + Full-Stack Engineer + Design Systems Specialist
> **Mission:** Take DClaw Offboard from scaffold (v0.1.0) to production-ready v1.0 by researching the market, designing future-proof AI-native features, and producing a complete build specification.
...
status: P4 Planned
repo: https://github.com/dclawstack/dclaw-offboard
docs: https://docs.dclawstack.io/apps/offboard
frontend_port: 3042
backend_port: 8042
db_name: dclaw_offboard
brand_color: #EF4444
icon: 🚪
```
...
Research the HR category and identify the 5 most relevant competitors to DClaw Offboard. For each:
- Name + URL
...
| Feature | DClaw Offboard (v0.1) | Competitor A | Competitor B | Competitor C | Competitor D | Competitor E |
|---------|---------------------------|--------------|--------------|--------------|--------------|--------------|
| Feature 1 | ❌ | ✅ | ✅ | ❌ | ✅ | ✅ |
| Feature 2 | ... | ... | ... | ... | ... | ... |
...
Features that are table stakes. Without these, DClaw Offboard is not viable.
...
Apply the **DKube Design System** to DClaw Offboard:
...
### 4.4 Dark Mode
DClaw Offboard supports both light and dark modes. Define the dark mode color mapping:
...
Structure:
```
# DClaw Offboard v1.0 Specification
