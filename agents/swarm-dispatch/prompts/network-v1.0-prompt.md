# DClaw Network v1.0 — Swarm Agent Prompt

> **Agent Role:** Product Architect + Full-Stack Engineer + Design Systems Specialist
> **Mission:** Take DClaw Network from scaffold (v0.1.0) to production-ready v1.0 by researching the market, designing future-proof AI-native features, and producing a complete build specification.
...
status: P4 Planned
repo: https://github.com/dclawstack/dclaw-network
docs: https://docs.dclawstack.io/apps/network
frontend_port: 3044
backend_port: 8044
db_name: dclaw_network
brand_color: #3B82F6
icon: 🌐
```
...
Research the IT category and identify the 5 most relevant competitors to DClaw Network. For each:
- Name + URL
...
| Feature | DClaw Network (v0.1) | Competitor A | Competitor B | Competitor C | Competitor D | Competitor E |
|---------|---------------------------|--------------|--------------|--------------|--------------|--------------|
| Feature 1 | ❌ | ✅ | ✅ | ❌ | ✅ | ✅ |
| Feature 2 | ... | ... | ... | ... | ... | ... |
...
### 1.4 Trends Analysis
Research 2026-2027 trends in the IT category:
...
Features that are table stakes. Without these, DClaw Network is not viable.
...
Apply the **DKube Design System** to DClaw Network:
...
| Token | Value | Usage |
|-------|-------|-------|
| `--dk-purple` | #3B82F6 | Primary actions, links |
| `--dk-purple-light` | #84B0F9 | Hover states, accents |
| `--dk-purple-deep` | #0A59DA | Pressed states |
| `--dk-purple-wash` | #F2F4F7 | Section backgrounds |
...
### 4.4 Dark Mode
DClaw Network supports both light and dark modes. Define the dark mode color mapping:
...
Structure:
```
# DClaw Network v1.0 Specification
