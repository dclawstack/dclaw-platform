# DClaw Research v1.0 — Swarm Agent Prompt

> **Agent Role:** Product Architect + Full-Stack Engineer + Design Systems Specialist
> **Mission:** Take DClaw Research from scaffold (v0.1.0) to production-ready v1.0 by researching the market, designing future-proof AI-native features, and producing a complete build specification.
...
name: DClaw Research
category: R&D
tagline: Research paper analysis and synthesis
current_version: 0.1.0
status: P4 Planned
repo: https://github.com/dclawstack/dclaw-research
docs: https://docs.dclawstack.io/apps/research
frontend_port: 3064
backend_port: 8064
db_name: dclaw_research
brand_color: #8B5CF6
icon: 🔬
```
...
Research the R&D category and identify the 5 most relevant competitors to DClaw Research. For each:
- Name + URL
...
| Feature | DClaw Research (v0.1) | Competitor A | Competitor B | Competitor C | Competitor D | Competitor E |
|---------|---------------------------|--------------|--------------|--------------|--------------|--------------|
| Feature 1 | ❌ | ✅ | ✅ | ❌ | ✅ | ✅ |
| Feature 2 | ... | ... | ... | ... | ... | ... |
...
### 1.4 Trends Analysis
Research 2026-2027 trends in the R&D category:
...
Features that are table stakes. Without these, DClaw Research is not viable.
...
Apply the **DKube Design System** to DClaw Research:
...
| Token | Value | Usage |
|-------|-------|-------|
| `--dk-purple` | #8B5CF6 | Primary actions, links |
| `--dk-purple-light` | #BEA4FA | Hover states, accents |
| `--dk-purple-deep` | #5713F1 | Pressed states |
| `--dk-purple-wash` | #F3F2F7 | Section backgrounds |
...
### 4.4 Dark Mode
DClaw Research supports both light and dark modes. Define the dark mode color mapping:
...
Structure:
```
# DClaw Research v1.0 Specification
