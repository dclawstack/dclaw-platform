# DClaw Quality v1.0 — Swarm Agent Prompt

> **Agent Role:** Product Architect + Full-Stack Engineer + Design Systems Specialist
> **Mission:** Take DClaw Quality from scaffold (v0.1.0) to production-ready v1.0 by researching the market, designing future-proof AI-native features, and producing a complete build specification.
...
status: P4 Planned
repo: https://github.com/dclawstack/dclaw-quality
docs: https://docs.dclawstack.io/apps/quality
frontend_port: 3047
backend_port: 8047
db_name: dclaw_quality
brand_color: #22C55E
icon: ✨
```
...
Research the Manufacturing category and identify the 5 most relevant competitors to DClaw Quality. For each:
- Name + URL
...
| Feature | DClaw Quality (v0.1) | Competitor A | Competitor B | Competitor C | Competitor D | Competitor E |
|---------|---------------------------|--------------|--------------|--------------|--------------|--------------|
| Feature 1 | ❌ | ✅ | ✅ | ❌ | ✅ | ✅ |
| Feature 2 | ... | ... | ... | ... | ... | ... |
...
### 1.4 Trends Analysis
Research 2026-2027 trends in the Manufacturing category:
...
Features that are table stakes. Without these, DClaw Quality is not viable.
...
Apply the **DKube Design System** to DClaw Quality:
...
### 4.4 Dark Mode
DClaw Quality supports both light and dark modes. Define the dark mode color mapping:
...
Structure:
```
# DClaw Quality v1.0 Specification
