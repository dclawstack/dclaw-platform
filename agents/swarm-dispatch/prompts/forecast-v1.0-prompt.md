# DClaw Forecast v1.0 — Swarm Agent Prompt

> **Agent Role:** Product Architect + Full-Stack Engineer + Design Systems Specialist
> **Mission:** Take DClaw Forecast from scaffold (v0.1.0) to production-ready v1.0 by researching the market, designing future-proof AI-native features, and producing a complete build specification.
...
status: P4 Planned
repo: https://github.com/dclawstack/dclaw-forecast
docs: https://docs.dclawstack.io/apps/forecast
frontend_port: 3046
backend_port: 8046
db_name: dclaw_forecast
brand_color: #06B6D4
icon: 🔮
```
...
Research the Operations category and identify the 5 most relevant competitors to DClaw Forecast. For each:
- Name + URL
...
| Feature | DClaw Forecast (v0.1) | Competitor A | Competitor B | Competitor C | Competitor D | Competitor E |
|---------|---------------------------|--------------|--------------|--------------|--------------|--------------|
| Feature 1 | ❌ | ✅ | ✅ | ❌ | ✅ | ✅ |
| Feature 2 | ... | ... | ... | ... | ... | ... |
...
Features that are table stakes. Without these, DClaw Forecast is not viable.
...
Apply the **DKube Design System** to DClaw Forecast:
...
### 4.4 Dark Mode
DClaw Forecast supports both light and dark modes. Define the dark mode color mapping:
...
Structure:
```
# DClaw Forecast v1.0 Specification
