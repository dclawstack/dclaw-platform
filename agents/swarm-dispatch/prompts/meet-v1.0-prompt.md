# DClaw Meet v1.0 — Swarm Agent Prompt

> **Agent Role:** Product Architect + Full-Stack Engineer + Design Systems Specialist
> **Mission:** Take DClaw Meet from scaffold (v0.1.0) to production-ready v1.0 by researching the market, designing future-proof AI-native features, and producing a complete build specification.
...
name: DClaw Meet
category: Meetings
tagline: Transcription, action items, and summaries
current_version: 0.1.0
status: P4 Planned
repo: https://github.com/dclawstack/dclaw-meet
...
Research the Meetings category and identify the 5 most relevant competitors to DClaw Meet. For each:
- Name + URL
...
| Feature | DClaw Meet (v0.1) | Competitor A | Competitor B | Competitor C | Competitor D | Competitor E |
|---------|---------------------------|--------------|--------------|--------------|--------------|--------------|
| Feature 1 | ❌ | ✅ | ✅ | ❌ | ✅ | ✅ |
| Feature 2 | ... | ... | ... | ... | ... | ... |
...
### 1.4 Trends Analysis
Research 2026-2027 trends in the Meetings category:
...
Features that are table stakes. Without these, DClaw Meet is not viable.
...
Apply the **DKube Design System** to DClaw Meet:
...
### 4.4 Dark Mode
DClaw Meet supports both light and dark modes. Define the dark mode color mapping:
