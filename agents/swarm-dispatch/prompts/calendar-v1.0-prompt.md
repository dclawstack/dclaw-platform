# DClaw Calendar v1.0 — Swarm Agent Prompt

> **Agent Role:** Product Architect + Full-Stack Engineer + Design Systems Specialist
> **Mission:** Take DClaw Calendar from scaffold (v0.1.0) to production-ready v1.0 by researching the market, designing future-proof AI-native features, and producing a complete build specification.
...
name: DClaw Calendar
category: Scheduling
tagline: AI scheduling and conflict resolution
current_version: 0.1.0
status: P4 Planned
repo: https://github.com/dclawstack/dclaw-calendar
docs: https://docs.dclawstack.io/apps/calendar
frontend_port: 3023
backend_port: 8023
db_name: dclaw_calendar
brand_color: #F59E0B
icon: 📅
```
...
Research the Scheduling category and identify the 5 most relevant competitors to DClaw Calendar. For each:
- Name + URL
...
| Feature | DClaw Calendar (v0.1) | Competitor A | Competitor B | Competitor C | Competitor D | Competitor E |
|---------|---------------------------|--------------|--------------|--------------|--------------|--------------|
| Feature 1 | ❌ | ✅ | ✅ | ❌ | ✅ | ✅ |
| Feature 2 | ... | ... | ... | ... | ... | ... |
...
### 1.4 Trends Analysis
Research 2026-2027 trends in the Scheduling category:
...
Features that are table stakes. Without these, DClaw Calendar is not viable.
...
Apply the **DKube Design System** to DClaw Calendar:
...
| Token | Value | Usage |
|-------|-------|-------|
| `--dk-purple` | #F59E0B | Primary actions, links |
| `--dk-purple-light` | #F8BB54 | Hover states, accents |
| `--dk-purple-deep` | #AC6E07 | Pressed states |
| `--dk-purple-wash` | #F7F5F1 | Section backgrounds |
...
### 4.4 Dark Mode
DClaw Calendar supports both light and dark modes. Define the dark mode color mapping:
...
Structure:
```
# DClaw Calendar v1.0 Specification
