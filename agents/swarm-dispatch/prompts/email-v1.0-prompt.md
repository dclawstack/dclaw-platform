# DClaw Mail v1.0 — Swarm Agent Prompt

> **Agent Role:** Product Architect + Full-Stack Engineer + Design Systems Specialist
> **Mission:** Take DClaw Mail from scaffold (v0.1.0) to production-ready v1.0 by researching the market, designing future-proof AI-native features, and producing a complete build specification.
...
name: DClaw Mail
category: Email
tagline: Smart inbox, auto-reply, and scheduling
current_version: 0.1.0
status: P4 Planned
repo: https://github.com/dclawstack/dclaw-email
docs: https://docs.dclawstack.io/apps/email
frontend_port: 3022
backend_port: 8022
db_name: dclaw_email
brand_color: #3B82F6
...
Research the Email category and identify the 5 most relevant competitors to DClaw Mail. For each:
- Name + URL
...
| Feature | DClaw Mail (v0.1) | Competitor A | Competitor B | Competitor C | Competitor D | Competitor E |
|---------|---------------------------|--------------|--------------|--------------|--------------|--------------|
| Feature 1 | ❌ | ✅ | ✅ | ❌ | ✅ | ✅ |
| Feature 2 | ... | ... | ... | ... | ... | ... |
...
### 1.4 Trends Analysis
Research 2026-2027 trends in the Email category:
...
Features that are table stakes. Without these, DClaw Mail is not viable.
...
Apply the **DKube Design System** to DClaw Mail:
...
### 4.4 Dark Mode
DClaw Mail supports both light and dark modes. Define the dark mode color mapping:
