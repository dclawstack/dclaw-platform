# DClaw Chat v1.0 — Swarm Agent Prompt

> **Agent Role:** Product Architect + Full-Stack Engineer + Design Systems Specialist
> **Mission:** Take DClaw Chat from scaffold (v0.1.0) to production-ready v1.0 by researching the market, designing future-proof AI-native features, and producing a complete build specification.
...
Research the Communication category and identify the 5 most relevant competitors to DClaw Chat. For each:
- Name + URL
...
| Feature | DClaw Chat (v0.1) | Competitor A | Competitor B | Competitor C | Competitor D | Competitor E |
|---------|---------------------------|--------------|--------------|--------------|--------------|--------------|
| Feature 1 | ❌ | ✅ | ✅ | ❌ | ✅ | ✅ |
| Feature 2 | ... | ... | ... | ... | ... | ... |
...
### 1.4 Trends Analysis
Research 2026-2027 trends in the Communication category:
...
Features that are table stakes. Without these, DClaw Chat is not viable.
...
Apply the **DKube Design System** to DClaw Chat:
...
### 4.4 Dark Mode
DClaw Chat supports both light and dark modes. Define the dark mode color mapping:
