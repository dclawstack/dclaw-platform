# DClaw Backup v1.0 — Swarm Agent Prompt

> **Agent Role:** Product Architect + Full-Stack Engineer + Design Systems Specialist
> **Mission:** Take DClaw Backup from scaffold (v0.1.0) to production-ready v1.0 by researching the market, designing future-proof AI-native features, and producing a complete build specification.
...
tagline: Intelligent backup and recovery
current_version: 0.1.0
status: P4 Planned
repo: https://github.com/dclawstack/dclaw-backup
docs: https://docs.dclawstack.io/apps/backup
frontend_port: 3032
backend_port: 8032
db_name: dclaw_backup
brand_color: #475569
icon: 💾
```
...
Research the Infrastructure category and identify the 5 most relevant competitors to DClaw Backup. For each:
- Name + URL
...
| Feature | DClaw Backup (v0.1) | Competitor A | Competitor B | Competitor C | Competitor D | Competitor E |
|---------|---------------------------|--------------|--------------|--------------|--------------|--------------|
| Feature 1 | ❌ | ✅ | ✅ | ❌ | ✅ | ✅ |
| Feature 2 | ... | ... | ... | ... | ... | ... |
...
### 1.4 Trends Analysis
Research 2026-2027 trends in the Infrastructure category:
...
Features that are table stakes. Without these, DClaw Backup is not viable.
...
Apply the **DKube Design System** to DClaw Backup:
...
| Token | Value | Usage |
|-------|-------|-------|
| `--dk-purple` | #475569 | Primary actions, links |
| `--dk-purple-light` | #657996 | Hover states, accents |
| `--dk-purple-deep` | #28303B | Pressed states |
| `--dk-purple-wash` | #F4F4F5 | Section backgrounds |
...
### 4.4 Dark Mode
DClaw Backup supports both light and dark modes. Define the dark mode color mapping:
...
Structure:
```
# DClaw Backup v1.0 Specification
