# DClaw Agent v1.0 — Swarm Agent Prompt

> **Agent Role:** Product Architect + Full-Stack Engineer + Design Systems Specialist
> **Mission:** Take DClaw Agent from scaffold (v0.1.0) to production-ready v1.0 by researching the market, designing future-proof AI-native features, and producing a complete build specification.
...
status: P1 Queued
repo: https://github.com/dclawstack/dclaw-agent
docs: https://docs.dclawstack.io/apps/agent
frontend_port: 3003
backend_port: 8003
db_name: dclaw_agent
brand_color: #8B5CF6
...
Research the Platform category and identify the 5 most relevant competitors to DClaw Agent. For each:
- Name + URL
...
| Feature | DClaw Agent (v0.1) | Competitor A | Competitor B | Competitor C | Competitor D | Competitor E |
|---------|---------------------------|--------------|--------------|--------------|--------------|--------------|
| Feature 1 | ❌ | ✅ | ✅ | ❌ | ✅ | ✅ |
| Feature 2 | ... | ... | ... | ... | ... | ... |
...
Features that are table stakes. Without these, DClaw Agent is not viable.
...
Apply the **DKube Design System** to DClaw Agent:
...
### 4.4 Dark Mode
DClaw Agent supports both light and dark modes. Define the dark mode color mapping:
...
Structure:
```
# DClaw Agent v1.0 Specification
