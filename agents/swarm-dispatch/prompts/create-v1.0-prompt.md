# DClaw Create v1.0 — Swarm Agent Prompt

> **Agent Role:** Product Architect + Full-Stack Engineer + Design Systems Specialist
> **Mission:** Take DClaw Create from scaffold (v0.1.0) to production-ready v1.0 by researching the market, designing future-proof AI-native features, and producing a complete build specification.
...
status: P3 Queued
repo: https://github.com/dclawstack/dclaw-create
docs: https://docs.dclawstack.io/apps/create
frontend_port: 3009
backend_port: 8009
db_name: dclaw_create
brand_color: #EC4899
icon: 🎨
```
...
Research the Media category and identify the 5 most relevant competitors to DClaw Create. For each:
- Name + URL
...
| Feature | DClaw Create (v0.1) | Competitor A | Competitor B | Competitor C | Competitor D | Competitor E |
|---------|---------------------------|--------------|--------------|--------------|--------------|--------------|
| Feature 1 | ❌ | ✅ | ✅ | ❌ | ✅ | ✅ |
| Feature 2 | ... | ... | ... | ... | ... | ... |
...
### 1.4 Trends Analysis
Research 2026-2027 trends in the Media category:
...
Features that are table stakes. Without these, DClaw Create is not viable.
...
Apply the **DKube Design System** to DClaw Create:
...
### 4.4 Dark Mode
DClaw Create supports both light and dark modes. Define the dark mode color mapping:
...
Structure:
```
# DClaw Create v1.0 Specification
