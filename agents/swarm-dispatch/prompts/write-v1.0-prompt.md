# DClaw Write v1.0 — Swarm Agent Prompt

> **Agent Role:** Product Architect + Full-Stack Engineer + Design Systems Specialist
> **Mission:** Take DClaw Write from scaffold (v0.1.0) to production-ready v1.0 by researching the market, designing future-proof AI-native features, and producing a complete build specification.
...
name: DClaw Write
category: Content
tagline: Long-form writing, blogging, and books
current_version: 0.1.0
status: P4 Planned
repo: https://github.com/dclawstack/dclaw-write
...
Research the Content category and identify the 5 most relevant competitors to DClaw Write. For each:
- Name + URL
...
| Feature | DClaw Write (v0.1) | Competitor A | Competitor B | Competitor C | Competitor D | Competitor E |
|---------|---------------------------|--------------|--------------|--------------|--------------|--------------|
| Feature 1 | ❌ | ✅ | ✅ | ❌ | ✅ | ✅ |
| Feature 2 | ... | ... | ... | ... | ... | ... |
...
### 1.4 Trends Analysis
Research 2026-2027 trends in the Content category:
...
Features that are table stakes. Without these, DClaw Write is not viable.
...
Apply the **DKube Design System** to DClaw Write:
...
| Token | Value | Usage |
|-------|-------|-------|
| `--dk-purple` | #F43F5E | Primary actions, links |
| `--dk-purple-light` | #F8879A | Hover states, accents |
| `--dk-purple-deep` | #DA0C2F | Pressed states |
...
### 4.4 Dark Mode
DClaw Write supports both light and dark modes. Define the dark mode color mapping:
...
Structure:
```
# DClaw Write v1.0 Specification
