# DClaw Design v1.0 — Swarm Agent Prompt

> **Agent Role:** Product Architect + Full-Stack Engineer + Design Systems Specialist
> **Mission:** Take DClaw Design from scaffold (v0.1.0) to production-ready v1.0 by researching the market, designing future-proof AI-native features, and producing a complete build specification.
...
name: DClaw Design
category: Design
tagline: UI/UX generation and design system management
current_version: 0.1.0
status: P4 Planned
repo: https://github.com/dclawstack/dclaw-design
docs: https://docs.dclawstack.io/apps/design
frontend_port: 3015
backend_port: 8015
db_name: dclaw_design
brand_color: #A855F7
icon: 🖌️
```
...
Research the Design category and identify the 5 most relevant competitors to DClaw Design. For each:
- Name + URL
...
| Feature | DClaw Design (v0.1) | Competitor A | Competitor B | Competitor C | Competitor D | Competitor E |
|---------|---------------------------|--------------|--------------|--------------|--------------|--------------|
| Feature 1 | ❌ | ✅ | ✅ | ❌ | ✅ | ✅ |
| Feature 2 | ... | ... | ... | ... | ... | ... |
...
### 1.4 Trends Analysis
Research 2026-2027 trends in the Design category:
...
Features that are table stakes. Without these, DClaw Design is not viable.
...
Apply the **DKube Design System** to DClaw Design:
...
| Token | Value | Usage |
|-------|-------|-------|
| `--dk-purple` | #A855F7 | Primary actions, links |
| `--dk-purple-light` | #CD9EFA | Hover states, accents |
| `--dk-purple-deep` | #820BF3 | Pressed states |
| `--dk-purple-wash` | #F4F2F7 | Section backgrounds |
...
### 4.4 Dark Mode
DClaw Design supports both light and dark modes. Define the dark mode color mapping:
...
Structure:
```
# DClaw Design v1.0 Specification
