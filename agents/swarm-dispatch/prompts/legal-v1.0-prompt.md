# DClaw Legal v1.0 — Swarm Agent Prompt

> **Agent Role:** Product Architect + Full-Stack Engineer + Design Systems Specialist
> **Mission:** Take DClaw Legal from scaffold (v0.1.0) to production-ready v1.0 by researching the market, designing future-proof AI-native features, and producing a complete build specification.
...
name: DClaw Legal
category: Legal
tagline: Contract review and case law research
current_version: 0.1.0
status: P4 Planned
repo: https://github.com/dclawstack/dclaw-legal
docs: https://docs.dclawstack.io/apps/legal
frontend_port: 3010
backend_port: 8010
db_name: dclaw_legal
brand_color: #475569
...
Research the Legal category and identify the 5 most relevant competitors to DClaw Legal. For each:
- Name + URL
...
| Feature | DClaw Legal (v0.1) | Competitor A | Competitor B | Competitor C | Competitor D | Competitor E |
|---------|---------------------------|--------------|--------------|--------------|--------------|--------------|
| Feature 1 | ❌ | ✅ | ✅ | ❌ | ✅ | ✅ |
| Feature 2 | ... | ... | ... | ... | ... | ... |
...
Features that are table stakes. Without these, DClaw Legal is not viable.
...
Apply the **DKube Design System** to DClaw Legal:
...
### 4.4 Dark Mode
DClaw Legal supports both light and dark modes. Define the dark mode color mapping:
...
Structure:
```
# DClaw Legal v1.0 Specification
