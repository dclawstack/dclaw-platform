# DClaw Carbon v1.0 — Swarm Agent Prompt

> **Agent Role:** Product Architect + Full-Stack Engineer + Design Systems Specialist
> **Mission:** Take DClaw Carbon from scaffold (v0.1.0) to production-ready v1.0 by researching the market, designing future-proof AI-native features, and producing a complete build specification.
...
status: P4 Planned
repo: https://github.com/dclawstack/dclaw-carbon
docs: https://docs.dclawstack.io/apps/carbon
frontend_port: 3035
backend_port: 8035
db_name: dclaw_carbon
brand_color: #22C55E
icon: 🌱
```
...
Research the Sustainability category and identify the 5 most relevant competitors to DClaw Carbon. For each:
- Name + URL
...
| Feature | DClaw Carbon (v0.1) | Competitor A | Competitor B | Competitor C | Competitor D | Competitor E |
|---------|---------------------------|--------------|--------------|--------------|--------------|--------------|
| Feature 1 | ❌ | ✅ | ✅ | ❌ | ✅ | ✅ |
| Feature 2 | ... | ... | ... | ... | ... | ... |
...
### 1.4 Trends Analysis
Research 2026-2027 trends in the Sustainability category:
...
Features that are table stakes. Without these, DClaw Carbon is not viable.
...
Apply the **DKube Design System** to DClaw Carbon:
...
| Token | Value | Usage |
|-------|-------|-------|
| `--dk-purple` | #22C55E | Primary actions, links |
| `--dk-purple-light` | #52E186 | Hover states, accents |
| `--dk-purple-deep` | #16833E | Pressed states |
| `--dk-purple-wash` | #F2F6F4 | Section backgrounds |
...
### 4.4 Dark Mode
DClaw Carbon supports both light and dark modes. Define the dark mode color mapping:
...
Structure:
```
# DClaw Carbon v1.0 Specification
