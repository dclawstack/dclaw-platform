# DClaw Building v1.0 — Swarm Agent Prompt

> **Agent Role:** Product Architect + Full-Stack Engineer + Design Systems Specialist
> **Mission:** Take DClaw Building from scaffold (v0.1.0) to production-ready v1.0 by researching the market, designing future-proof AI-native features, and producing a complete build specification.
...
status: P4 Planned
repo: https://github.com/dclawstack/dclaw-building
docs: https://docs.dclawstack.io/apps/building
frontend_port: 3055
backend_port: 8055
db_name: dclaw_building
brand_color: #8B5CF6
icon: 🏢
```
...
Research the Real Estate category and identify the 5 most relevant competitors to DClaw Building. For each:
- Name + URL
...
| Feature | DClaw Building (v0.1) | Competitor A | Competitor B | Competitor C | Competitor D | Competitor E |
|---------|---------------------------|--------------|--------------|--------------|--------------|--------------|
| Feature 1 | ❌ | ✅ | ✅ | ❌ | ✅ | ✅ |
| Feature 2 | ... | ... | ... | ... | ... | ... |
...
Features that are table stakes. Without these, DClaw Building is not viable.
...
Apply the **DKube Design System** to DClaw Building:
...
### 4.4 Dark Mode
DClaw Building supports both light and dark modes. Define the dark mode color mapping:
...
Structure:
```
# DClaw Building v1.0 Specification
