# DClaw Space v1.0 — Swarm Agent Prompt

> **Agent Role:** Product Architect + Full-Stack Engineer + Design Systems Specialist
> **Mission:** Take DClaw Space from scaffold (v0.1.0) to production-ready v1.0 by researching the market, designing future-proof AI-native features, and producing a complete build specification.
...
status: P4 Planned
repo: https://github.com/dclawstack/dclaw-space
docs: https://docs.dclawstack.io/apps/space
frontend_port: 3056
backend_port: 8056
db_name: dclaw_space
brand_color: #A855F7
...
Research the Real Estate category and identify the 5 most relevant competitors to DClaw Space. For each:
- Name + URL
...
| Feature | DClaw Space (v0.1) | Competitor A | Competitor B | Competitor C | Competitor D | Competitor E |
|---------|---------------------------|--------------|--------------|--------------|--------------|--------------|
| Feature 1 | ❌ | ✅ | ✅ | ❌ | ✅ | ✅ |
| Feature 2 | ... | ... | ... | ... | ... | ... |
...
### 1.4 Trends Analysis
Research 2026-2027 trends in the Real Estate category:
...
Features that are table stakes. Without these, DClaw Space is not viable.
...
Apply the **DKube Design System** to DClaw Space:
...
### 4.4 Dark Mode
DClaw Space supports both light and dark modes. Define the dark mode color mapping:
...
Structure:
```
# DClaw Space v1.0 Specification
