# DClaw Policy v1.0 — Swarm Agent Prompt

> **Agent Role:** Product Architect + Full-Stack Engineer + Design Systems Specialist
> **Mission:** Take DClaw Policy from scaffold (v0.1.0) to production-ready v1.0 by researching the market, designing future-proof AI-native features, and producing a complete build specification.
...
name: DClaw Policy
category: Governance
tagline: Policy management and enforcement
current_version: 0.1.0
status: P4 Planned
repo: https://github.com/dclawstack/dclaw-policy
docs: https://docs.dclawstack.io/apps/policy
frontend_port: 3038
backend_port: 8038
db_name: dclaw_policy
brand_color: #8B5CF6
icon: 📜
```
...
Research the Governance category and identify the 5 most relevant competitors to DClaw Policy. For each:
- Name + URL
...
| Feature | DClaw Policy (v0.1) | Competitor A | Competitor B | Competitor C | Competitor D | Competitor E |
|---------|---------------------------|--------------|--------------|--------------|--------------|--------------|
| Feature 1 | ❌ | ✅ | ✅ | ❌ | ✅ | ✅ |
| Feature 2 | ... | ... | ... | ... | ... | ... |
...
Features that are table stakes. Without these, DClaw Policy is not viable.
...
Apply the **DKube Design System** to DClaw Policy:
...
### 4.4 Dark Mode
DClaw Policy supports both light and dark modes. Define the dark mode color mapping:
...
Structure:
```
# DClaw Policy v1.0 Specification
