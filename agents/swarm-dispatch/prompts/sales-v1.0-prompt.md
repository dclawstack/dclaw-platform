# DClaw Sales v1.0 — Swarm Agent Prompt

> **Agent Role:** Product Architect + Full-Stack Engineer + Design Systems Specialist
> **Mission:** Take DClaw Sales from scaffold (v0.1.0) to production-ready v1.0 by researching the market, designing future-proof AI-native features, and producing a complete build specification.
...
name: DClaw Sales
category: Sales
tagline: CRM AI, email sequences, and forecasting
current_version: 0.1.0
status: P4 Planned
repo: https://github.com/dclawstack/dclaw-sales
docs: https://docs.dclawstack.io/apps/sales
frontend_port: 3012
backend_port: 8012
db_name: dclaw_sales
brand_color: #F97316
...
Research the Sales category and identify the 5 most relevant competitors to DClaw Sales. For each:
- Name + URL
...
| Feature | DClaw Sales (v0.1) | Competitor A | Competitor B | Competitor C | Competitor D | Competitor E |
|---------|---------------------------|--------------|--------------|--------------|--------------|--------------|
| Feature 1 | ❌ | ✅ | ✅ | ❌ | ✅ | ✅ |
| Feature 2 | ... | ... | ... | ... | ... | ... |
...
### 1.4 Trends Analysis
Research 2026-2027 trends in the Sales category:
...
Features that are table stakes. Without these, DClaw Sales is not viable.
...
Apply the **DKube Design System** to DClaw Sales:
...
### 4.4 Dark Mode
DClaw Sales supports both light and dark modes. Define the dark mode color mapping:
...
Structure:
```
# DClaw Sales v1.0 Specification
