# DClaw Secure v1.0 — Swarm Agent Prompt

> **Agent Role:** Product Architect + Full-Stack Engineer + Design Systems Specialist
> **Mission:** Take DClaw Secure from scaffold (v0.1.0) to production-ready v1.0 by researching the market, designing future-proof AI-native features, and producing a complete build specification.
...
name: DClaw Secure
category: Security
tagline: Threat detection and vulnerability scanning
current_version: 0.1.0
status: P4 Planned
repo: https://github.com/dclawstack/dclaw-secure
docs: https://docs.dclawstack.io/apps/secure
frontend_port: 3031
backend_port: 8031
db_name: dclaw_secure
brand_color: #DC2626
icon: 🔒
```
...
Research the Security category and identify the 5 most relevant competitors to DClaw Secure. For each:
- Name + URL
...
| Feature | DClaw Secure (v0.1) | Competitor A | Competitor B | Competitor C | Competitor D | Competitor E |
|---------|---------------------------|--------------|--------------|--------------|--------------|--------------|
| Feature 1 | ❌ | ✅ | ✅ | ❌ | ✅ | ✅ |
| Feature 2 | ... | ... | ... | ... | ... | ... |
...
### 1.4 Trends Analysis
Research 2026-2027 trends in the Security category:
...
Features that are table stakes. Without these, DClaw Secure is not viable.
...
Apply the **DKube Design System** to DClaw Secure:
...
| Token | Value | Usage |
|-------|-------|-------|
| `--dk-purple` | #DC2626 | Primary actions, links |
| `--dk-purple-light` | #E66767 | Hover states, accents |
| `--dk-purple-deep` | #9C1919 | Pressed states |
| `--dk-purple-wash` | #F7F2F2 | Section backgrounds |
...
### 4.4 Dark Mode
DClaw Secure supports both light and dark modes. Define the dark mode color mapping:
...
Structure:
```
# DClaw Secure v1.0 Specification
