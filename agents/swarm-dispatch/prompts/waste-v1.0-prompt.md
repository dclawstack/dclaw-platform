# DClaw Waste v1.0 — Swarm Agent Prompt

> **Agent Role:** Product Architect + Full-Stack Engineer + Design Systems Specialist
> **Mission:** Take DClaw Waste from scaffold (v0.1.0) to production-ready v1.0 by researching the market, designing future-proof AI-native features, and producing a complete build specification.
...
status: P4 Planned
repo: https://github.com/dclawstack/dclaw-waste
docs: https://docs.dclawstack.io/apps/waste
frontend_port: 3054
backend_port: 8054
db_name: dclaw_waste
brand_color: #22C55E
...
Research the Sustainability category and identify the 5 most relevant competitors to DClaw Waste. For each:
- Name + URL
...
| Feature | DClaw Waste (v0.1) | Competitor A | Competitor B | Competitor C | Competitor D | Competitor E |
|---------|---------------------------|--------------|--------------|--------------|--------------|--------------|
| Feature 1 | ❌ | ✅ | ✅ | ❌ | ✅ | ✅ |
| Feature 2 | ... | ... | ... | ... | ... | ... |
...
Features that are table stakes. Without these, DClaw Waste is not viable.
...
Apply the **DKube Design System** to DClaw Waste:
...
### 4.4 Dark Mode
DClaw Waste supports both light and dark modes. Define the dark mode color mapping:
...
Structure:
```
# DClaw Waste v1.0 Specification
