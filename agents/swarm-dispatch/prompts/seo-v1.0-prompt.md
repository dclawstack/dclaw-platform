# DClaw SEO v1.0 — Swarm Agent Prompt

> **Agent Role:** Product Architect + Full-Stack Engineer + Design Systems Specialist
> **Mission:** Take DClaw SEO from scaffold (v0.1.0) to production-ready v1.0 by researching the market, designing future-proof AI-native features, and producing a complete build specification.
...
status: P3 Queued
repo: https://github.com/dclawstack/dclaw-seo
docs: https://docs.dclawstack.io/apps/seo
frontend_port: 3008
backend_port: 8008
db_name: dclaw_seo
brand_color: #F97316
...
Research the Marketing category and identify the 5 most relevant competitors to DClaw SEO. For each:
- Name + URL
...
| Feature | DClaw SEO (v0.1) | Competitor A | Competitor B | Competitor C | Competitor D | Competitor E |
|---------|---------------------------|--------------|--------------|--------------|--------------|--------------|
| Feature 1 | ❌ | ✅ | ✅ | ❌ | ✅ | ✅ |
| Feature 2 | ... | ... | ... | ... | ... | ... |
...
### 1.4 Trends Analysis
Research 2026-2027 trends in the Marketing category:
...
Features that are table stakes. Without these, DClaw SEO is not viable.
...
Apply the **DKube Design System** to DClaw SEO:
...
### 4.4 Dark Mode
DClaw SEO supports both light and dark modes. Define the dark mode color mapping:
