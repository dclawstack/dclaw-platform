# DClaw Contract v1.0 — Swarm Agent Prompt

> **Agent Role:** Product Architect + Full-Stack Engineer + Design Systems Specialist
> **Mission:** Take DClaw Contract from scaffold (v0.1.0) to production-ready v1.0 by researching the market, designing future-proof AI-native features, and producing a complete build specification.
...
status: P4 Planned
repo: https://github.com/dclawstack/dclaw-contract
docs: https://docs.dclawstack.io/apps/contract
frontend_port: 3059
backend_port: 8059
db_name: dclaw_contract
brand_color: #475569
icon: 📑
```
...
Research the Legal category and identify the 5 most relevant competitors to DClaw Contract. For each:
- Name + URL
...
| Feature | DClaw Contract (v0.1) | Competitor A | Competitor B | Competitor C | Competitor D | Competitor E |
|---------|---------------------------|--------------|--------------|--------------|--------------|--------------|
| Feature 1 | ❌ | ✅ | ✅ | ❌ | ✅ | ✅ |
| Feature 2 | ... | ... | ... | ... | ... | ... |
...
Features that are table stakes. Without these, DClaw Contract is not viable.
...
Apply the **DKube Design System** to DClaw Contract:
...
### 4.4 Dark Mode
DClaw Contract supports both light and dark modes. Define the dark mode color mapping:
...
Structure:
```
# DClaw Contract v1.0 Specification
