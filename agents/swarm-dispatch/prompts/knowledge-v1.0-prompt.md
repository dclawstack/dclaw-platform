# DClaw Knowledge v1.0 — Swarm Agent Prompt

> **Agent Role:** Product Architect + Full-Stack Engineer + Design Systems Specialist
> **Mission:** Take DClaw Knowledge from scaffold (v0.1.0) to production-ready v1.0 by researching the market, designing future-proof AI-native features, and producing a complete build specification.
...
status: P4 Planned
repo: https://github.com/dclawstack/dclaw-knowledge
docs: https://docs.dclawstack.io/apps/knowledge
frontend_port: 3063
backend_port: 8063
db_name: dclaw_knowledge
brand_color: #6366F1
icon: 🧠
```
...
Research the Platform category and identify the 5 most relevant competitors to DClaw Knowledge. For each:
- Name + URL
...
| Feature | DClaw Knowledge (v0.1) | Competitor A | Competitor B | Competitor C | Competitor D | Competitor E |
|---------|---------------------------|--------------|--------------|--------------|--------------|--------------|
| Feature 1 | ❌ | ✅ | ✅ | ❌ | ✅ | ✅ |
| Feature 2 | ... | ... | ... | ... | ... | ... |
...
### 1.4 Trends Analysis
Research 2026-2027 trends in the Platform category:
...
Features that are table stakes. Without these, DClaw Knowledge is not viable.
...
Apply the **DKube Design System** to DClaw Knowledge:
...
### 4.4 Dark Mode
DClaw Knowledge supports both light and dark modes. Define the dark mode color mapping:
...
Structure:
```
# DClaw Knowledge v1.0 Specification
