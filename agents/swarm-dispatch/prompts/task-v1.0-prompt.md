# DClaw Task v1.0 — Swarm Agent Prompt

> **Agent Role:** Product Architect + Full-Stack Engineer + Design Systems Specialist
> **Mission:** Take DClaw Task from scaffold (v0.1.0) to production-ready v1.0 by researching the market, designing future-proof AI-native features, and producing a complete build specification.
...
tagline: Smart to-do and project management
current_version: 0.1.0
status: P4 Planned
repo: https://github.com/dclawstack/dclaw-task
docs: https://docs.dclawstack.io/apps/task
frontend_port: 3024
backend_port: 8024
db_name: dclaw_task
brand_color: #8B5CF6
...
Research the Productivity category and identify the 5 most relevant competitors to DClaw Task. For each:
- Name + URL
...
| Feature | DClaw Task (v0.1) | Competitor A | Competitor B | Competitor C | Competitor D | Competitor E |
|---------|---------------------------|--------------|--------------|--------------|--------------|--------------|
| Feature 1 | ❌ | ✅ | ✅ | ❌ | ✅ | ✅ |
| Feature 2 | ... | ... | ... | ... | ... | ... |
...
### 1.4 Trends Analysis
Research 2026-2027 trends in the Productivity category:
...
Features that are table stakes. Without these, DClaw Task is not viable.
...
Apply the **DKube Design System** to DClaw Task:
...
### 4.4 Dark Mode
DClaw Task supports both light and dark modes. Define the dark mode color mapping:
