# DClaw Doc v1.0 — Swarm Agent Prompt

> **Agent Role:** Product Architect + Full-Stack Engineer + Design Systems Specialist
> **Mission:** Take DClaw Doc from scaffold (v0.1.0) to production-ready v1.0 by researching the market, designing future-proof AI-native features, and producing a complete build specification.
...
name: DClaw Doc
category: Documents
tagline: Smart documents and collaborative editing
current_version: 0.1.0
status: P4 Planned
repo: https://github.com/dclawstack/dclaw-doc
...
Research the Documents category and identify the 5 most relevant competitors to DClaw Doc. For each:
- Name + URL
...
| Feature | DClaw Doc (v0.1) | Competitor A | Competitor B | Competitor C | Competitor D | Competitor E |
|---------|---------------------------|--------------|--------------|--------------|--------------|--------------|
| Feature 1 | ❌ | ✅ | ✅ | ❌ | ✅ | ✅ |
| Feature 2 | ... | ... | ... | ... | ... | ... |
...
### 1.4 Trends Analysis
Research 2026-2027 trends in the Documents category:
...
Features that are table stakes. Without these, DClaw Doc is not viable.
...
Apply the **DKube Design System** to DClaw Doc:
...
| Token | Value | Usage |
|-------|-------|-------|
| `--dk-purple` | #0EA5E9 | Primary actions, links |
| `--dk-purple-light` | #4FC1F4 | Hover states, accents |
| `--dk-purple-deep` | #0971A0 | Pressed states |
| `--dk-purple-wash` | #F2F5F7 | Section backgrounds |
...
### 4.4 Dark Mode
DClaw Doc supports both light and dark modes. Define the dark mode color mapping:
