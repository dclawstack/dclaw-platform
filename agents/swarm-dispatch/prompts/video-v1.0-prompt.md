# DClaw Video v1.0 — Swarm Agent Prompt

> **Agent Role:** Product Architect + Full-Stack Engineer + Design Systems Specialist
> **Mission:** Take DClaw Video from scaffold (v0.1.0) to production-ready v1.0 by researching the market, designing future-proof AI-native features, and producing a complete build specification.
...
status: P4 Planned
repo: https://github.com/dclawstack/dclaw-video
docs: https://docs.dclawstack.io/apps/video
frontend_port: 3067
backend_port: 8067
db_name: dclaw_video
brand_color: #EC4899
...
Research the Media category and identify the 5 most relevant competitors to DClaw Video. For each:
- Name + URL
...
| Feature | DClaw Video (v0.1) | Competitor A | Competitor B | Competitor C | Competitor D | Competitor E |
|---------|---------------------------|--------------|--------------|--------------|--------------|--------------|
| Feature 1 | ❌ | ✅ | ✅ | ❌ | ✅ | ✅ |
| Feature 2 | ... | ... | ... | ... | ... | ... |
...
Features that are table stakes. Without these, DClaw Video is not viable.
...
Apply the **DKube Design System** to DClaw Video:
...
### 4.4 Dark Mode
DClaw Video supports both light and dark modes. Define the dark mode color mapping:
...
Structure:
```
# DClaw Video v1.0 Specification
