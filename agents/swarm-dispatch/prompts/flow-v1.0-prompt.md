# DClaw Flow v1.0 — Swarm Agent Prompt

> **Agent Role:** Product Architect + Full-Stack Engineer + Design Systems Specialist
> **Mission:** Take DClaw Flow from scaffold (v0.1.0) to production-ready v1.0 by researching the market, designing future-proof AI-native features, and producing a complete build specification.
...
status: P1 Queued
repo: https://github.com/dclawstack/dclaw-flow
docs: https://docs.dclawstack.io/apps/flow
frontend_port: 3002
backend_port: 8002
db_name: dclaw_flow
brand_color: #10B981
...
Research the Automation category and identify the 5 most relevant competitors to DClaw Flow. For each:
- Name + URL
...
| Feature | DClaw Flow (v0.1) | Competitor A | Competitor B | Competitor C | Competitor D | Competitor E |
|---------|---------------------------|--------------|--------------|--------------|--------------|--------------|
| Feature 1 | ❌ | ✅ | ✅ | ❌ | ✅ | ✅ |
| Feature 2 | ... | ... | ... | ... | ... | ... |
...
### 1.4 Trends Analysis
Research 2026-2027 trends in the Automation category:
...
Features that are table stakes. Without these, DClaw Flow is not viable.
...
Apply the **DKube Design System** to DClaw Flow:
...
### 4.4 Dark Mode
DClaw Flow supports both light and dark modes. Define the dark mode color mapping:
