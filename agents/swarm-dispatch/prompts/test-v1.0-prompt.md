# DClaw Test v1.0 — Swarm Agent Prompt

> **Agent Role:** Product Architect + Full-Stack Engineer + Design Systems Specialist
> **Mission:** Take DClaw Test from scaffold (v0.1.0) to production-ready v1.0 by researching the market, designing future-proof AI-native features, and producing a complete build specification.
...
name: DClaw Test
category: QA
tagline: Automated testing and bug prediction
current_version: 0.1.0
status: P4 Planned
repo: https://github.com/dclawstack/dclaw-test
...
Research the QA category and identify the 5 most relevant competitors to DClaw Test. For each:
- Name + URL
...
| Feature | DClaw Test (v0.1) | Competitor A | Competitor B | Competitor C | Competitor D | Competitor E |
|---------|---------------------------|--------------|--------------|--------------|--------------|--------------|
| Feature 1 | ❌ | ✅ | ✅ | ❌ | ✅ | ✅ |
| Feature 2 | ... | ... | ... | ... | ... | ... |
...
### 1.4 Trends Analysis
Research 2026-2027 trends in the QA category:
...
Features that are table stakes. Without these, DClaw Test is not viable.
...
Apply the **DKube Design System** to DClaw Test:
...
### 4.4 Dark Mode
DClaw Test supports both light and dark modes. Define the dark mode color mapping:
