# DClaw Patent v1.0 — Swarm Agent Prompt

> **Agent Role:** Product Architect + Full-Stack Engineer + Design Systems Specialist
> **Mission:** Take DClaw Patent from scaffold (v0.1.0) to production-ready v1.0 by researching the market, designing future-proof AI-native features, and producing a complete build specification.
...
name: DClaw Patent
category: Legal
tagline: Patent search and analysis
current_version: 0.1.0
status: P4 Planned
repo: https://github.com/dclawstack/dclaw-patent
docs: https://docs.dclawstack.io/apps/patent
frontend_port: 3065
backend_port: 8065
db_name: dclaw_patent
brand_color: #3B82F6
icon: 📋
```
...
Research the Legal category and identify the 5 most relevant competitors to DClaw Patent. For each:
- Name + URL
...
| Feature | DClaw Patent (v0.1) | Competitor A | Competitor B | Competitor C | Competitor D | Competitor E |
|---------|---------------------------|--------------|--------------|--------------|--------------|--------------|
| Feature 1 | ❌ | ✅ | ✅ | ❌ | ✅ | ✅ |
| Feature 2 | ... | ... | ... | ... | ... | ... |
...
### 1.4 Trends Analysis
Research 2026-2027 trends in the Legal category:
...
Features that are table stakes. Without these, DClaw Patent is not viable.
...
Apply the **DKube Design System** to DClaw Patent:
...
### 4.4 Dark Mode
DClaw Patent supports both light and dark modes. Define the dark mode color mapping:
...
Structure:
```
# DClaw Patent v1.0 Specification
