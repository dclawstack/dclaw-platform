# DClaw Maintenance v1.0 — Swarm Agent Prompt

> **Agent Role:** Product Architect + Full-Stack Engineer + Design Systems Specialist
> **Mission:** Take DClaw Maintenance from scaffold (v0.1.0) to production-ready v1.0 by researching the market, designing future-proof AI-native features, and producing a complete build specification.
...
status: P4 Planned
repo: https://github.com/dclawstack/dclaw-maintenance
docs: https://docs.dclawstack.io/apps/maintenance
frontend_port: 3048
backend_port: 8048
db_name: dclaw_maintenance
brand_color: #F97316
icon: 🔧
```
...
Research the Operations category and identify the 5 most relevant competitors to DClaw Maintenance. For each:
- Name + URL
...
| Feature | DClaw Maintenance (v0.1) | Competitor A | Competitor B | Competitor C | Competitor D | Competitor E |
|---------|---------------------------|--------------|--------------|--------------|--------------|--------------|
| Feature 1 | ❌ | ✅ | ✅ | ❌ | ✅ | ✅ |
| Feature 2 | ... | ... | ... | ... | ... | ... |
...
### 1.4 Trends Analysis
Research 2026-2027 trends in the Operations category:
...
Features that are table stakes. Without these, DClaw Maintenance is not viable.
...
Apply the **DKube Design System** to DClaw Maintenance:
...
| Token | Value | Usage |
|-------|-------|-------|
| `--dk-purple` | #F97316 | Primary actions, links |
| `--dk-purple-light` | #FA9F60 | Hover states, accents |
| `--dk-purple-deep` | #BD5004 | Pressed states |
| `--dk-purple-wash` | #F7F4F1 | Section backgrounds |
...
### 4.4 Dark Mode
DClaw Maintenance supports both light and dark modes. Define the dark mode color mapping:
...
Structure:
```
# DClaw Maintenance v1.0 Specification
