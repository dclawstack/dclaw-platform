# DClaw Energy v1.0 — Swarm Agent Prompt

> **Agent Role:** Product Architect + Full-Stack Engineer + Design Systems Specialist
> **Mission:** Take DClaw Energy from scaffold (v0.1.0) to production-ready v1.0 by researching the market, designing future-proof AI-native features, and producing a complete build specification.
...
status: P4 Planned
repo: https://github.com/dclawstack/dclaw-energy
docs: https://docs.dclawstack.io/apps/energy
frontend_port: 3052
backend_port: 8052
db_name: dclaw_energy
brand_color: #F59E0B
icon: ⚡
```
...
Research the Utilities category and identify the 5 most relevant competitors to DClaw Energy. For each:
- Name + URL
...
| Feature | DClaw Energy (v0.1) | Competitor A | Competitor B | Competitor C | Competitor D | Competitor E |
|---------|---------------------------|--------------|--------------|--------------|--------------|--------------|
| Feature 1 | ❌ | ✅ | ✅ | ❌ | ✅ | ✅ |
| Feature 2 | ... | ... | ... | ... | ... | ... |
...
### 1.4 Trends Analysis
Research 2026-2027 trends in the Utilities category:
...
Features that are table stakes. Without these, DClaw Energy is not viable.
...
Apply the **DKube Design System** to DClaw Energy:
...
### 4.4 Dark Mode
DClaw Energy supports both light and dark modes. Define the dark mode color mapping:
...
Structure:
```
# DClaw Energy v1.0 Specification
