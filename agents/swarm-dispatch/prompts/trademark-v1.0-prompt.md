# DClaw Trademark v1.0 — Swarm Agent Prompt

> **Agent Role:** Product Architect + Full-Stack Engineer + Design Systems Specialist
> **Mission:** Take DClaw Trademark from scaffold (v0.1.0) to production-ready v1.0 by researching the market, designing future-proof AI-native features, and producing a complete build specification.
...
category: Legal
tagline: Trademark monitoring
current_version: 0.1.0
status: P4 Planned
repo: https://github.com/dclawstack/dclaw-trademark
docs: https://docs.dclawstack.io/apps/trademark
frontend_port: 3066
backend_port: 8066
db_name: dclaw_trademark
brand_color: #F59E0B
icon: ™️
```
...
Research the Legal category and identify the 5 most relevant competitors to DClaw Trademark. For each:
- Name + URL
...
| Feature | DClaw Trademark (v0.1) | Competitor A | Competitor B | Competitor C | Competitor D | Competitor E |
|---------|---------------------------|--------------|--------------|--------------|--------------|--------------|
| Feature 1 | ❌ | ✅ | ✅ | ❌ | ✅ | ✅ |
| Feature 2 | ... | ... | ... | ... | ... | ... |
...
Features that are table stakes. Without these, DClaw Trademark is not viable.
...
Apply the **DKube Design System** to DClaw Trademark:
...
### 4.4 Dark Mode
DClaw Trademark supports both light and dark modes. Define the dark mode color mapping:
...
Structure:
```
# DClaw Trademark v1.0 Specification
