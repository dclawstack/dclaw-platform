# DClaw Translate v1.0 — Swarm Agent Prompt

> **Agent Role:** Product Architect + Full-Stack Engineer + Design Systems Specialist
> **Mission:** Take DClaw Translate from scaffold (v0.1.0) to production-ready v1.0 by researching the market, designing future-proof AI-native features, and producing a complete build specification.
...
category: Language
tagline: Real-time translation and localization
current_version: 0.1.0
status: P4 Planned
repo: https://github.com/dclawstack/dclaw-translate
docs: https://docs.dclawstack.io/apps/translate
frontend_port: 3016
backend_port: 8016
db_name: dclaw_translate
brand_color: #84CC16
icon: 🌐
```
...
Research the Language category and identify the 5 most relevant competitors to DClaw Translate. For each:
- Name + URL
...
| Feature | DClaw Translate (v0.1) | Competitor A | Competitor B | Competitor C | Competitor D | Competitor E |
|---------|---------------------------|--------------|--------------|--------------|--------------|--------------|
| Feature 1 | ❌ | ✅ | ✅ | ❌ | ✅ | ✅ |
| Feature 2 | ... | ... | ... | ... | ... | ... |
...
### 1.4 Trends Analysis
Research 2026-2027 trends in the Language category:
...
Features that are table stakes. Without these, DClaw Translate is not viable.
...
Apply the **DKube Design System** to DClaw Translate:
...
| Token | Value | Usage |
|-------|-------|-------|
| `--dk-purple` | #84CC16 | Primary actions, links |
| `--dk-purple-light` | #A8EA43 | Hover states, accents |
| `--dk-purple-deep` | #57860E | Pressed states |
| `--dk-purple-wash` | #F5F7F2 | Section backgrounds |
...
### 4.4 Dark Mode
DClaw Translate supports both light and dark modes. Define the dark mode color mapping:
...
Structure:
```
# DClaw Translate v1.0 Specification
