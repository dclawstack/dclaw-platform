# DClaw Med v1.0 — Swarm Agent Prompt

> **Agent Role:** Product Architect + Full-Stack Engineer + Design Systems Specialist
> **Mission:** Take DClaw Med from scaffold (v0.1.0) to production-ready v1.0 by researching the market, designing future-proof AI-native features, and producing a complete build specification.
...
status: P2 Queued
repo: https://github.com/dclawstack/dclaw-med
docs: https://docs.dclawstack.io/apps/med
frontend_port: 3005
backend_port: 8005
db_name: dclaw_med
brand_color: #EF4444
...
Research the Healthcare category and identify the 5 most relevant competitors to DClaw Med. For each:
- Name + URL
...
| Feature | DClaw Med (v0.1) | Competitor A | Competitor B | Competitor C | Competitor D | Competitor E |
|---------|---------------------------|--------------|--------------|--------------|--------------|--------------|
| Feature 1 | ❌ | ✅ | ✅ | ❌ | ✅ | ✅ |
| Feature 2 | ... | ... | ... | ... | ... | ... |
...
### 1.4 Trends Analysis
Research 2026-2027 trends in the Healthcare category:
...
Features that are table stakes. Without these, DClaw Med is not viable.
...
Apply the **DKube Design System** to DClaw Med:
...
### 4.4 Dark Mode
DClaw Med supports both light and dark modes. Define the dark mode color mapping:
