# DClaw App Builder — Swarm Agent Prompt

> **Agent Role:** Product Architect + Full-Stack Engineer + Design Systems Specialist  
> **Mission:** Take a DClaw app from scaffold (v0.1.0) to production-ready v1.0 by researching the market, designing future-proof AI-native features, and producing a complete build specification.  
...
Research the app's category and identify the 5 most relevant competitors. For each:
- Name + URL
...
| Feature | DClaw {{APP_NAME}} (v0.1) | Competitor A | Competitor B | Competitor C | Competitor D | Competitor E |
|---------|---------------------------|--------------|--------------|--------------|--------------|--------------|
| Feature 1 | ❌ | ✅ | ✅ | ❌ | ✅ | ✅ |
| Feature 2 | ... | ... | ... | ... | ... | ... |
...
### 1.4 Trends Analysis
Research 2026-2027 trends in this category:
...
Features that are table stakes. Without these, the app is not viable.
...
Apply the **DKube Design System** to this app:
...
| Token | Value | Usage |
|-------|-------|-------|
| `--dk-purple` | {{APP_BRAND_COLOR}} | Primary actions, links |
| `--dk-purple-light` | {{APP_BRAND_LIGHT}} | Hover states, accents |
| `--dk-purple-deep` | {{APP_BRAND_DEEP}} | Pressed states |
| `--dk-purple-wash` | {{APP_BRAND_WASH}} | Section backgrounds |
...
### 4.4 Dark Mode
DClaw apps support both light and dark modes. Define the dark mode color mapping:
